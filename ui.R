                            ...
                            sidebarLayout(
                              ...
                              sidebarPanel(
                                ...
                                selectInput("RegionMap", label = h3("Select Region"), 
                                            choices = list("Australasia/Oceania", "Central America", "Central Asia", "East Asia", "Eastern Europe", "Middle East/North Africa", "North America", "South America", "South Asia", "Southeast Asia", "Sub-Saharan Africa", "Western Europe"), 
                              ...
                              mainPanel(
                                ...
                                p("Selecting a range of years will show the map of terrorist activity for the selected years. Changing the type will show different points on the map for target type, attack type or weapon type. Selecting different regions will change the underlying map that is displayed. If no map shows up, there is no data for the selected inputs."),
